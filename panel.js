...
app.get('/auth/telegram',(req,res)=>{
  ...
  u.searchParams.set('client_id',TELEGRAM_CLIENT_ID); u.searchParams.set('redirect_uri',TELEGRAM_REDIRECT_URI); u.searchParams.set('response_type','code');
